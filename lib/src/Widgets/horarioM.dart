...
class HorarioM extends StatelessWidget {
  const HorarioM({Key? key}) : super(key: key);
            ...
            Row(
              ...
              children: [
                DropdownButton(
                  ...
                  value: prefillDataEcoP.getDiaEntrada,
                  menuMaxHeight: 150,
                  ...
                  onChanged: (value) {
                    prefillDataEcoP.setDiaEntrada = value.toString();
                  },
                ),
                DropdownButton(
                  alignment: AlignmentDirectional.center,
                  ...
                  dropdownColor: const Color(0xFF383838),
                  style: const TextStyle(color: Colors.white),
                  value: prefillDataEcoP.getDiaSalida,
                  // Down Arrow Icon
                  icon: const Icon(null),
                  menuMaxHeight: 150,
                  // Array list of items
                  ...
                  onChanged: (value) {
                    prefillDataEcoP.setDiaSalida = value.toString();
                  },
                ...
                TextButton(
                  ...
                  onPressed: () async {
                    prefillDataEcoP.setHoraEntrada =
                        await _mostrarAlert(context, prefillDataEcoP.getHoraEntrada);
                  },
                ),
                TextButton(
                  child: Text(
                  ...
                  onPressed: () async {
                    prefillDataEcoP.setHoraSalida =
                        await _mostrarAlert(context, prefillDataEcoP.getHoraSalida);
                  },
                ),
              ],
            ),
